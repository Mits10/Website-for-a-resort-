...
<html lang="en">
  <head>
    ...
    <!-- Main Style -->
    <link href="bookcover.css" rel="stylesheet">
  ...
  <body>
			...
			<nav class="navbar navbar-default mu-navbar">
			  	<div class="container-fluid">
				    ...
				    <div class="navbar-header">
				      ...
				      <!-- Text Logo -->
				      <a class="navbar-brand" href="index.php"><i class="fa fa-book" aria-hidden="true"></i> ReadMe</a>
	...
	<section id="mu-hero">
		<div class="container">
            ...
            <?php
            $mage=mysqli_query($db,"SELECT `bookimage` FROM `book`WHERE authorname=''$author';");
						echo "<img src=$mage>";
            ?>
					</div>
				</div>
            ...
            <?php
            $res=mysqli_query($db,"SELECT `bookname` FROM `book` WHERE authorname='$author';");
						echo "<h1>";echo $res;echo"</h1>";
						echo "<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quam saepe, recusandae quidem nulla! Eveniet explicabo perferendis aut, ab quos omnis labore laboriosam quisquam hic deserunt ipsum maxime aspernatur velit impedit.</p>";
            ?>
